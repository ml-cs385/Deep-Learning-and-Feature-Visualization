...
tf.app.flags.DEFINE_string('train_dir', '/home/xs-caomengqi/Machine-Learning-Project/ResNet-Cifar10-ImageNet-TensorFlow/resnet_train_log',
...
def train(is_training, logits, images, labels):
    ...
    loss_ = loss(logits, labels) # from resnet.py
    ...
    config.log_device_placement = False # attribute from original code
